...
| GET | `/api/integrations/caddi` | canonical contract-only DvSum CADDI/Genesys/NXT capability and authority map |
| GET | `/api/integrations/cadi` | deprecated compatibility alias for `/api/integrations/caddi` |
